...
public class StreamEx01 {
    ...
    public static void main(String[] args) {
        ...
        //boxed 메서드를 사용해서 IntStream을 Stream<Integer>
        List<Integer> list1 = IntStream.rangeClosed(1,10).filter(number -> number %2 == 0).boxed().collect(Collectors.toList());
        list.forEach(System.out::println);

        //소문자 영문 과일 이름을 대문자로 시작하는 과일명으로 변경하기
        ...
        //문자 stream을 생성하고, 각 문장의 단어 수를 계산하는 기능
